...
- (instancetype)init
{
    self = [super init];
    if (self) {
        NSArray *array = @[[BN_ShopPayMentChannelModel paymentChannelModel:@"" payName:TEXT(@"微信支付") payExplain:TEXT(@"微信安全支付") payType:BN_ShopPaymentType_WX], [BN_ShopPayMentChannelModel paymentChannelModel:@"" payName:TEXT(@"支付宝支付") payExplain:TEXT(@"支付宝安全支付") payType:BN_ShopPaymentType_Alipay]];
